...
def search_articles_by_text(
    ...
    min_days: Optional[int] = None,   # ADDED: articles published at least N days ago
    ...
    min_days       : Restrict to articles published at least N days ago
                     ...
                     Useful for "old news" or ranges like
                     "between 3 and 7 days ago" combined with max_days=7.
    ...
    # max_days → upper bound: pub_timestamp >= (now - max_days)
    ...
    # min_days → lower bound: pub_timestamp <= (now - min_days)
    # Ensures articles newer than N days are excluded.
