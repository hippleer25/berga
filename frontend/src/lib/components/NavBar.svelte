...
<style>
    ...
    .nav-item {
        ...
        /* Improved contrast: 60% instead of 40% */
  ...
  color: var(--color-accent);
    ...
    @media (min-width: 768px) {
        .sidebar {
            ...
            z-index: 50;
            width: 240px; /* Slightly wider to fit text comfortably */
            flex-direction: column;
            background: var(--color-base-100); /* Fundo base igual ao conteúdo principal */
            border-right: 1px solid var(--color-base-200); /* Real border that separates */
        }
    }
    ...
    .sidebar-item {
        ...
        border-left: 3px solid transparent; /* Prepares border for active state */
        text-decoration: none;
        color: color-mix(in oklch, var(--color-base-content) 60%, transparent);
        position: relative;
        overflow: hidden;
